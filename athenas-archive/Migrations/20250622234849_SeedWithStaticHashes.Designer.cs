...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("athenas_archive.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("athenas_archive.Entities.Curtida", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.LogAcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Notificacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Resposta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Topico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.TopicoTag", b =>
                {
                    b.Property<int>("TopicoId")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("athenas_archive.Entities.Curtida", b =>
                {
                    b.HasOne("athenas_archive.Entities.Resposta", "Resposta")
                        .WithMany("Curtidas")
                        .HasForeignKey("RespostaId");

                    b.HasOne("athenas_archive.Entities.Topico", "Topico")
                        .WithMany("Curtidas")
                        .HasForeignKey("TopicoId");

                    b.HasOne("athenas_archive.Entities.Usuario", "Usuario")
                        .WithMany("Curtidas")
            ...
            modelBuilder.Entity("athenas_archive.Entities.Resposta", b =>
                {
                    b.HasOne("athenas_archive.Entities.Resposta", "RespostaPai")
            ...
            modelBuilder.Entity("athenas_archive.Entities.Topico", b =>
                {
                    b.HasOne("athenas_archive.Entities.Categoria", "Categoria")
                        .WithMany("Topicos")
            ...
            modelBuilder.Entity("athenas_archive.Entities.TopicoTag", b =>
                {
                    b.HasOne("athenas_archive.Entities.Tag", "Tag")
                        .WithMany("TopicoTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("athenas_archive.Entities.Usuario", b =>
                {
                    b.HasOne("athenas_archive.Entities.Role", "Role")
                        .WithMany("Usuarios")
